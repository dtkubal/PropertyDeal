...
namespace PropertyDeal.Core.Log
{
    public interface ILogger
    {
        ...
        void Debug(string message, System.Exception exception, params object[] args);
        ...
        /// <param name="args">The arguments values</param>
        void LogError(string message, System.Exception exception, params object[] args);
